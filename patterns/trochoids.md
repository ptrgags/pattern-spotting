...
- [Hypotrochoid (wiki)](https://en.wikipedia.org/wiki/Hypotrochoid)
    ...
    - so in terms of [circular motion](./circular-motion.md) we have $((R - r)C_n + dC_{n(R-r)/r})C_1$
...
- TODO: Are there choices of $R, r, d$ that produce [rose curves](./rose-curves.md) or [lissajous curves](./lissajous.md) curves?
