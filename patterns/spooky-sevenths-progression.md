...
![Diagram of piano keyboards showing that only one note moves up by a half step each time](figures/spooky-sevenths-path-a.png)

Taking the first path, we get 

C<sup>o7</sup>-C<sup>ø7</sup>-Cm7-C7-CM7-C+7-C+

![Similar diagram for the other path](figures/spooky-sevenths-path-b.png)
