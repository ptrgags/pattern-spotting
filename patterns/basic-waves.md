...
- $\text{sawtooth}(t) = 1 - 2\text{mod}(t, 1)$
...
- $\text{square}(t) = \text{sgn}(\sin(2 \pi t))$
- `square = sgn * sine`
- TODO: Alternate recipes. E.g. a digital square wave from $[0, 1]$ is just $\text{mod}(n, 2)$ for an integer $n$
